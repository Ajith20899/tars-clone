...
import TwoStepVerification from "@/app/(auth)/(common)/TwoStepVerification";
        ...
        <form className="flex flex-col gap-3 mt-4">
          ...
          <div className="flex items-center justify-between mt-2 space-x-2">
            <div className="flex items-center space-x-2 cursor-pointer">
              <Checkbox id="terms" />
              <Label htmlFor="terms" className="text-xs cursor-default">
                Remember me
              </Label>
            </div>
            <Label
          ...
          <a className="block w-max mx-auto mt-2 cursor-pointer text-xs pb-0.5 border-b border-borderColor text-center">
            Need help?
          </a>
