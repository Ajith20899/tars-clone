...
export function PlaceHolderShimmer({ className }: { className: string }) {
  return (
    <div
      className={cn(
        "w-full h-full absolute left-0 top-0 rounded-sm shimmer",
        className
      )}
    ></div>
  );
...
export function GoogleSpinner({
  ...
  return (
    <svg className={cn("w-[18px] h-[18px] animate-spin fill-primary", className)} viewBox="3 3 18 18">
